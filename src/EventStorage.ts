...
export interface EventStorage {
	...
	produceEventsForTypes<T extends string[]>(typesAggregateIdsMinVersions: Array<[T[keyof T], Optional<string>, Optional<number>]>, fromDate: Optional<Date>): {[I in keyof T]: Generator<Event<T[I], any>>};
	produceEventsForTypesAsync<T extends string[]>(typesAggregateIdsMinVersions: Array<[T[keyof T], Optional<string>, Optional<number>]>, fromDate: Optional<Date>): {[I in keyof T]: AsyncGenerator<Event<T[I], any>>};
	storeEvents(...events: Array<Event<any, any>>): Promise<void>;
}
...
export class InMemoryDomainEventStorage implements EventStorage {
	...
	async storeEvents(...events: Array<DomainEvent<any, any, any>>): Promise<void> {
	...
	produceEventsForTypes<T extends string[]>(typesAggregateIdsMinVersions: Array<[T[keyof T], Optional<string>, Optional<number>]>, fromDate: Optional<Date>): {[I in keyof T]: Generator<Event<T[I], any>>;} {
		...
		return record as {[I in keyof T]: Generator<Event<T[I], any>>;};
	}
	...
	produceEventsForTypesAsync<T extends string[]>(typesAggregateIdsMinVersions: Array<[T[keyof T], Optional<string>, Optional<number>]>, fromDate: Optional<Date>): {[I in keyof T]: AsyncGenerator<Event<T[I], any>>;} {
		...
		return record as {[I in keyof T]: AsyncGenerator<Event<T[I], any>>;};
	}

	protected filterByAggregateId<T extends string>(aggregateId: Optional<string>, list: Array<DomainEvent<T, any, any>>): Array<DomainEvent<T, any, any>> {
	...
	protected filterByDate<T extends string>(fromDate: Optional<Date>, list: Array<Event<T, any>>): Array<Event<T, any>> {
	...
	protected filterByVersion<T extends string>(fromVersion: Optional<number>, list: Array<DomainEvent<T, any, any>>): Array<DomainEvent<T, any, any>> {
